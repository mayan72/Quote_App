...
const arrindex=Math.floor(Math.random()*quotes.length);
document.getElementById('tbox').innerHTML=quotes[arrindex].quote;
document.getElementById('abox').innerHTML=quotes[arrindex].source;
...
document.getElementById("loadQuote").addEventListener("click", genquote);
}
